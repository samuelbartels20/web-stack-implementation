...
Next, assign ownership of the directory with the <span style="color:red">projectlamp </span> environment variable, which will reference your current system user: