...
With this VirtualHost configuration, we’re telling Apache to serve <span style="color:red">projectlamp </span> using **/var/wwwprojectlampl as its web root directory. If you would like to test Apache without a domain name, you can remove or comment out the options ServerName and ServerAlias by adding a # character in the beginning of each option’s lines. Adding the # character there will tell the program to skip processing the instructions on those lines.