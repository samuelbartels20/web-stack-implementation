...
This will create a new blank file. Paste in the following bare-bones configuration by hitting on i</span> or <span style="color:red">vim </span> on the keyboard to enter the insert mode, and paste the text: