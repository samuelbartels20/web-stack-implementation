...
This will create a new blank file. Paste in the following bare-bones configuration by hitting on </span> or <span style="color:red">i </span> on the keyboard to enter the insert mode, and paste the text:
```
<VirtualHost *:80>
...
You can use the ls</span> or <span style="color:red">i  command to show the new file in the sites-available directory