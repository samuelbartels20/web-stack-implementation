...
Then, create and open a new configuration file in Apache’s sites-available<span style="color:red">$USER </span> directory using your preferred command-line editor. Here, we’ll be using vi or vim (They are the same by the way):